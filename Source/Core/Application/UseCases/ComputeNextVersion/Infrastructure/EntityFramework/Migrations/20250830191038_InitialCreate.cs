        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentifierName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    ReleaseNumber = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    Meta = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
